# -*- coding: utf-8 -*-
__filename = '/Users/cihanandac/Documents/Code files/zeeuwsmuseumproject/backend/env/lib/python3.10/site-packages/z3c/form/browser/text_hidden.pt'
...
_static_4709742192 = {'id': '', 'name': '', 'value': '', 'class': 'hidden-widget', 'title': '', 'tabindex': '', 'accesskey': '', 'type': 'hidden', }
_static_4709736480 = {'xmlns': 'http://www.w3.org/1999/xhtml', }
...
def initialize(modules, nothing, tales, zope_version_5_6_0_):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<ast.Dict object at 0x118b8e020> name=None at 118b8ee90> -> __attrs_4709735664
            __attrs_4709735664 = _static_4709736480
            __append('\n')

            # <Static value=<ast.Dict object at 0x118b8f670> name=None at 118b8fd90> -> __attrs_4709734512
            __attrs_4709734512 = _static_4709742192

            # <input ... (0:0)
            # --------------------------------------------------------
            __append('<input')

            # <Symbol value=<DEFAULT> at 109c89f90> -> __default_4709739312
            __default_4709739312 = _DEFAULT_MARKER

            # <Substitution 'view/id' (7:26)> -> __attr_id
            __token = 256
            try:
                __zt_tmp = __attrs_4709734512
            ...
            # <Symbol value=<DEFAULT> at 109c89f90> -> __default_4709740896
            __default_4709740896 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 109c89f90> -> __default_4709742384
            __default_4709742384 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 109c89f90> -> __default_4709741952
            __default_4709741952 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 109c89f90> -> __default_4709739552
            __default_4709739552 = _DEFAULT_MARKER
