...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_27__["jsxs"])(_plone_volto_components_manage_Pluggable__WEBPACK_IMPORTED_MODULE_15__["PluggablesProvider"], {
      ...
      }), /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_27__["jsx"])(_plone_volto_components__WEBPACK_IMPORTED_MODULE_19__["AppExtras"], _objectSpread({}, this.props)), document.getElementById('main').style.width = `calc(100vw - ${window.innerWidth - document.body.clientWidth}px)`, "document.getElementById('page-document').style.width = `calc(100vw - $", window.innerWidth - document.body.clientWidth, "px)`"]
    });
  }
...
//# sourceMappingURL=server.36cc5db45dfe0aaef4a5.hot-update.js.map