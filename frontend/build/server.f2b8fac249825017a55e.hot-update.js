                      ...
                      for (let item2 of item1.items) {
                        ...
                        for (let item3 of item2.items) {
                          ...
                          if (item3.title == parentTitle) {
                            ...
                            menuArray = item3.items; // console.log(menuArray)

                            for (let item of menuArray) {
                              if (item.title == 'IMAGES') {
                                menuArray.pop('IMAGES');
                              }
                            }
                          ...
                          for (let item4 of item3.items) {
                            if (item4.title == parentTitle) {
                              menuArray = item4.items; // console.log(menuArray)
...
//# sourceMappingURL=server.f2b8fac249825017a55e.hot-update.js.map