...
class BreadcrumbsComponent extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__["jsxs"])(semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Segment"], {
      ...
      secondary: true,
      vertical: true,
      children: [console.log(this.props.items.map((item, index, items) => [item.title])), console.log(this.props.items.map((item, index, items) => [item.title])), /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__["jsx"])(semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Container"], {
...
//# sourceMappingURL=server.f3c867517214521f37ea.hot-update.js.map