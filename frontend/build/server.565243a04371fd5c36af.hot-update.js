...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  // {document.getElementById('field-Page_Type').childNodes[1].children[0].children[0].children[0].firstChild.wholeText === "Jaarverslag Folder" ? document.getElementById('footer').style.display="none" : document.getElementById('footer').style.display="block" }
  //
...
//# sourceMappingURL=server.565243a04371fd5c36af.hot-update.js.map