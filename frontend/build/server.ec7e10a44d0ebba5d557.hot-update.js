...
const FormattedDate = ({
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__["jsx"])("time", {
    className: className,
    dateTime: date,
    title: new Intl.DateTimeFormat(language, _plone_volto_helpers_Utils_Date__WEBPACK_IMPORTED_MODULE_2__["short_date_format"]).format(new Date(toDate(date))),
...
//# sourceMappingURL=server.ec7e10a44d0ebba5d557.hot-update.js.map