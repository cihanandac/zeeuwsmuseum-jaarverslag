...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    {
      document.getElementById('field-Page_Type').childNodes[1].children[0].children[0].children[0].firstChild.wholeText === 'Jaarverslag Folder' ? document.getElementById('footer').className = 'invisibleFooter' : document.getElementById('footer').className = 'visibleFooter';
    }
...
//# sourceMappingURL=server.110698ca5cf9a2ba1562.hot-update.js.map