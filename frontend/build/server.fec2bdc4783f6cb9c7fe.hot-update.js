...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  // {document.getElementById('field-Page_Type').childNodes[1].children[0].children[0].children[0].firstChild.wholeText === "Jaarverslag Folder"" ? console.log("yes") : console.log("no") }
  // document.getElementById('footer').style.display="none" : document.getElementById('footer').style.display="block"
...
//# sourceMappingURL=server.fec2bdc4783f6cb9c7fe.hot-update.js.map