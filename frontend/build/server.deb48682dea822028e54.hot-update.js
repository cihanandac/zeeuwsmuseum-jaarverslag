...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    {
      content.props.type === 'sliderpage' ? document.getElementById('footer').style.className = 'inviz' : document.getElementById('footer').style.className = 'viz';
    }
...
//# sourceMappingURL=server.deb48682dea822028e54.hot-update.js.map